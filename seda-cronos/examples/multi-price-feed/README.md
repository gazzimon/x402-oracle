...
- A single price pair (whitelisted) like `BTC-USD` or `ETH-USDT`
- Or a JSON string: `{"pair":"BTC-USD"}`

### Process

1. Validates the Data Request execution argument is in the format of `SymbolA-SymbolB` and is whitelisted.
