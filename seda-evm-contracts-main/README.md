...
## Cronos Testnet Prover Deployment (MVP)

This testnet deployment boots with batch 0 and zeroed roots for an explicit, non-production anchor.

### Parameters

- Prover params: `config/initialBatch.testnet.json`
- Core params: `config/core.testnet.json`

### Deployed Addresses (cronosTestnet, chainId 338)
...
For a full deployment record, see [DEPLOYMENTS.md](DEPLOYMENTS.md).
